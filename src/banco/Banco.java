...
ImageIcon b =new ImageIcon(this.getClass().getResource("folder/Update.png"));
...
//--------------------------------------------------------------------------------------
 Calendar data = Calendar.getInstance();
       ...
       int dat =data.get(Calendar.DAY_OF_MONTH);
       int ano =data.get(Calendar.YEAR);
      
       
JLabel a = new JLabel(b);
JLabel foot = new JLabel("Sistema de Informação do Banco Moz - 2019                   Data: " +dat+" / "+6+" / "+ano);
...
iU.addActionListener((ActionEvent e) -> {
    try{
      String a;
       ...
       if(a.equals("12345")){new ADM();} else{JOptionPane.showMessageDialog(null, "          Senha Errada!");}
...
//------------------------------------------------------------------------------
  this.setSize(1320,680);
   ...
   this.setTitle("Sistema do Banco Moz 2019. Menu Principal");
...
//   txtV.setBounds(385,150, 180,25);
   ...
   butADD.setBounds(1025, 500,150,27);butADD.setBackground(Color.white); butADD.setIcon(ic13);
    ...
    Cliente.setBackground(new Color(255,204,204));
   ...
   scrollNome.setBounds(20, 280, 870, 165);
    ...
    Conta.setBackground(new Color(255,204,204));
   ...
   dele.setBounds(700,245, 170, 29);dele.setBackground(Color.white);dele.setIcon(ic25);
    ...
    FT.setBackground(new Color(255,204,204));
    ...
    OP.setBackground(new Color(255,204,204));
...
//tabelaNomes.addMouseListener(new MouseListener(){
//
//       @Override
//       public void mouseClicked(MouseEvent e) {
//           
//       int indice=tabelaNomes.getSelectedRow();
//       index(indice);
//      }
//
//       @Override
...
public int last(){
 va a;
   ...
   if(xy.size()>0){
      ...
      //JOptionPane.showMessageDialog(null,a.cnumero);
    cal = Integer.parseInt(a.cnumero);
    cal=cal+1;
...
public int mostra(va a ){//JOptionPane.showMessageDialog(null,a.cnumero);
    cal = Integer.parseInt(a.cnumero);
    cal=cal+1;
    //JOptionPane.showMessageDialog(null,cal);
...
//    
//    a=(va)xy.get(inde);  
//     JOptionPane.showMessageDialog(null,inde);
//     //xy.removeAllElements();
//     
//      mostra(a);
//    
//    }
// public void mostra(va a ){
//      
//     txtnumero.setText(a.cnumero);
//     txtmoeda.setSelectedItem(a.cmoeda);
//     txttipo.setSelectedItem(a.ctipo);
//     txtsaldo.setText(a.csaldo+"");
//     txtDataA.setText(a.cDataAB);
//    
//     }
// 
...
public void prenche(){
    ...
    while (modeloTab.getRowCount()>0) modeloTab.removeRow(0);
        ...
        for(int j=0;j<xy.size();j++){  
         ...
         a=(va)xy.get(j);  
          if(a.cnomeC.equals(txtnome.getText())){
             linha[0]=a.cnumero;
             linha[1]=a.ctipo;
             linha[2]=a.cmoeda; 
             linha[3]=a.csaldo+""; 
...
public ImageIcon foto(){
    ...
    String Caminho=null;
    try{
    JFileChooser choose = new JFileChooser("C:/Users/Antonio Cua/Documents/NetBeansProjects/Banco/foto/Cliente/");
...
public void Registo(){
 try {
      if(txtnome.getText().length()!=0 && txtNUIT.getText().length()!=0&& txtsaldo.getText().length()!=0 &&       
        txtDataA.getText().length()!=0 && txtDataN.getText().length()!=0){ 
        va a = new va();
...
public void RegistoCl(){
 ...
 try {
     ...
     if(txtnome.getText().length()!=0&&txtNUIT.getText().length()!=0&&txtDataA.getText().length()!=0){
        va a = new va();
        a.cnomeC=txtnome.getText();
        a.cNUITC=txtNUIT.getText();
        a.cnumero=this.last()+"";
        a.ctipo=txttipo.getSelectedItem().toString();
        a.cmoeda=txtmoeda.getSelectedItem().toString();
        a.csaldo=Double.parseDouble(txtsaldo.getText());
        a.cDataAB=txtDataA.getText();
...
public void Apagar(){
    ...
    if(txtNUIT.getText().length()!=0){ 
     ...
     while (modeloTab.getRowCount()>0) modeloTab.removeRow(0);
     //---------------------------------------------------
            JOptionPane.showMessageDialog(null,"Cliente e Conta/as Apagados do Sistema. Obrigado!"); 
         }        
...
public void ApagarCO(String nui){
     ...
     //---------------------------------------------------
        ...
        // JOptionPane.showMessageDialog(null,"Conta/as Apagada do Sistema. Obrigado!");
         try {
          ob.gravarObjecto(xy,"CO.DAT");
       } catch(Exception e){}
     }
    ...
    while (modeloTab2.getRowCount()>0) modeloTab2.removeRow(0);
        ...
        for(int j=0;j<xy.size();j++){  
         ...
         a=(va)xy.get(j);  
          ...
          if(a.cnomeC.equals(txtname.getText())){ 
              txtcod.setText(a.cNUITC); 
             linha[0]=a.cnumero;
             linha[1]=a.ctipo;
             linha[2]=a.cmoeda; 
             linha[3]=a.csaldo+""; 
...
public void InfoN(){
    ...
    while (modeloTab2.getRowCount()>0) modeloTab2.removeRow(0);
        ...
        for(int j=0;j<xy.size();j++){  
         ...
         if(a.cNUITC.equals(txtcod.getText())){ 
              txtname.setText(a.cnomeC);
             linha[0]=a.cnumero;
             linha[1]=a.ctipo;
             linha[2]=a.cmoeda; 
             linha[3]=a.csaldo+""; 
...
JLabel lblcodi = new JLabel("Nuit do Cliente:");
JLabel lblnami = new JLabel("Nome do Cliente:");

JLabel lbltoi = new JLabel("Saldo Atual do Cliente:");
JTextField txttoi = new  JTextField();


JLabel lblvd = new JLabel("Valor a Depositar na Conta:");
JTextField txtvd = new  JTextField();


JLabel lbls = new JLabel("Novo Saldo Actual do Cliente:");
...
JTextField txtnami = new  JTextField();
...
//    
   ...
   lblcodi.setBounds(120,40, 290,25);
   lblnami.setBounds(460,40,100,25);
   txtcodi.setBounds(240,40, 200,25);
   txtnami.setBounds(590,40, 270,25);
   l.setBounds(870,40,30,24);
...
//    contal.setBounds(90, 110, 200, 25);
//    conta.setBounds(300, 110, 290, 25);conta.setBackground(Color.white); 
//    
    lbltoi.setBounds(90, 160, 200, 25);
    txttoi.setBounds(300,160,290,24);
    
    
    lblvd.setBounds(90, 220, 200, 25);
    txtvd.setBounds(300,220,290,24);
   
    
    lbls.setBounds(90, 280, 200, 25);
    txts.setBounds(300,280,290,24);
...
txtcodi.addActionListener((ActionEvent e) -> {
       Busca();
    });
txtnami.addActionListener((ActionEvent e) -> {
       Busca2();
    });
txtvd.addActionListener((ActionEvent e) -> {
       Calcula();
    });
...
public void Busca(){
   ...
   // conta.removeAllItems();
        for(int j=0;j<xy.size();j++){  
         ...
         if(a.cNUITC.equals(txtcodi.getText())){ 
             
           txtnami.setText(a.cnomeC); 
           
           txttoi.setText(a.csaldo+""); 
    ...
    va a = new va(); 
     ...
     //conta.removeAllItems();
        ...
        for(int j=0;j<xy.size();j++){  
         ...
         if(a.cnomeC.equals(txtnami.getText())){ 
             
           txtcodi.setText(a.cNUITC);
           txttoi.setText(a.csaldo+""); 
          // conta.addItem(a.cnumero);
   ...
   txts.setText(null);
    ...
    va a = new va(); 
        ...
        for(int j=0;j<xy.size();j++){  
         ...
         if(a.cnumero.equals(conta.getSelectedItem().toString())){ 
...
public void Calcula(){
    ...
    double s = Double.parseDouble(txttoi.getText());
    double d = Double.parseDouble(txtvd.getText());
...
//                 
//     
//        a.csaldo=Double.parseDouble(txts.getText());
//        
//        
//                 xy.setElementAt(a,i);   
//               JOptionPane.showMessageDialog(null, "       Depósito com Sucesso. Obrigado");MovD();  
//             }  
//         }
// 
//   txtcodi.setText(null);
...
public void MovD(){
 ...
 try {
       ...
       int m =data.get(Calendar.YEAR);
        ...
        va a = new va();
        a.setMnome(txtnami.getText());
        a.setMnuit(txtcodi.getText());
        a.setMvalor(Double.parseDouble(txtvd.getText()));
...
JLabel lblvd = new JLabel("Insira o Valor a Levantar:");
JTextField txtvd = new  JTextField();
...
//    
    ...
    Pesq.setLayout(null);
    Pesq.setBounds(90,20,830,60);
    Pesq.setBackground(new Color(255,204,204));
...
JLabel lblvd = new JLabel("Insira o Valor a Tranferir:");
JTextField txtvd = new  JTextField();


JLabel lbls = new JLabel("Insira a Conta a Transferir:");
JTextField txts = new  JTextField();
...
//    
   ...
   l.setBounds(870,40,30,24);
    ...
    lbltoi.setBounds(90, 130, 200, 25);
    txttoi.setBounds(300,130,290,24);
    
    
    lblvd.setBounds(90, 190, 200, 25);
    txtvd.setBounds(300,190,290,24);
    
    
    lbls.setBounds(90, 250, 200, 25);
    txts.setBounds(300,250,290,24);
...
public void Calcula(){
    ...
    if(txttoi.getText().length()!=0 && txtvd.getText().length()!=0){
    ...
    }else{JOptionPane.showMessageDialog(null,"      Valor Insuficiente");txtvd.setText(null);}
...
va a = new va();
         ...
         for(int i=0;i<xy.size();i++){
             ...
             if(a.cNUITC.equals(NUIT)){    
                 double d = Double.parseDouble(txtvd.getText());
                 double at=Double.parseDouble(txttoi.getText());
                // double soma=at-d;
             ...
             if(a.cnumero.equals(txts.getText())){   
                 
                 a.csaldo=a.csaldo+Double.parseDouble(txtvd.getText());
...
public void InfoN(){
    ...
    while (modeloTab3.getRowCount()>0) modeloTab3.removeRow(0);
        ...
        for(int j=0;j<xy.size();j++){  
         ...
         if(a.cmoeda.equals(txtcod.getText())){ 
